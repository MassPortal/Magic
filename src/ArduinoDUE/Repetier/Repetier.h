...
#define COOLER0_ANALOG_INPUTS 1
#define COOLER0_ANALOG_INDEX THERMO_ANALOG_INPUTS+EXT0_ANALOG_INPUTS+EXT1_ANALOG_INPUTS+EXT2_ANALOG_INPUTS+EXT3_ANALOG_INPUTS+EXT4_ANALOG_INPUTS+EXT5_ANALOG_INPUTS+BED_ANALOG_INPUTS+CHAMBER_ANALOG_INPUTS
#define COOLER0_ANALOG_CHANNEL BED_KOMMA COOLER0_SENSOR_PIN
#else
#define COOLER0_ANALOG_INPUTS 0
#define COOLER0_ANALOG_CHANNEL
#endif

#if COOLER1_SENSOR_PIN > -1
#define COOLER1_ANALOG_INPUTS 1
#define COOLER1_ANALOG_INDEX THERMO_ANALOG_INPUTS+EXT0_ANALOG_INPUTS+EXT1_ANALOG_INPUTS+EXT2_ANALOG_INPUTS+EXT3_ANALOG_INPUTS+EXT4_ANALOG_INPUTS+EXT5_ANALOG_INPUTS+BED_ANALOG_INPUTS+CHAMBER_ANALOG_INPUTS+COOLER0_ANALOG_INPUTS
#define COOLER1_ANALOG_CHANNEL BED_KOMMA COOLER1_SENSOR_PIN
#else
#define COOLER1_ANALOG_INPUTS 0
#define COOLER1_ANALOG_CHANNEL
#endif
...
#define ANALOG_INPUTS (EXT0_ANALOG_INPUTS+EXT1_ANALOG_INPUTS+EXT2_ANALOG_INPUTS+EXT3_ANALOG_INPUTS+EXT4_ANALOG_INPUTS+EXT5_ANALOG_INPUTS+BED_ANALOG_INPUTS+THERMO_ANALOG_INPUTS+CHAMBER_ANALOG_INPUTS+COOLER0_ANALOG_INPUTS+COOLER1_ANALOG_INPUTS + 1)
#if ANALOG_INPUTS > 0
/** Channels are the MUX-part of ADMUX register */
#define  ANALOG_INPUT_CHANNELS {EXT0_ANALOG_CHANNEL EXT1_ANALOG_CHANNEL EXT2_ANALOG_CHANNEL EXT3_ANALOG_CHANNEL EXT4_ANALOG_CHANNEL EXT5_ANALOG_CHANNEL BED_ANALOG_CHANNEL THERMO_ANALOG_CHANNEL CHAMBER_ANALOG_CHANNEL COOLER0_ANALOG_CHANNEL COOLER1_ANALOG_CHANNEL, THERMOCOUPLE_0_PIN}
#endif
