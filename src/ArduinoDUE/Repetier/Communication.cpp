...
FSTRINGVALUE(Com::tFan3speed,"Fanspeed3:")
...
FSTRINGVALUE(Com::tChamber,"chamber")
...
FSTRINGVALUE(Com::tZProbeFailed,"[002] Failed to calibrate the printbed!")
...
FSTRINGVALUE(Com::tPrinterModel,"Printer model")
FSTRINGVALUE(Com::tExtruderCount,"Extruder count")
FSTRINGVALUE(Com::tHeatbedType,"Heat bed type")
FSTRINGVALUE(Com::tUinterfaceType,"UI type")
FSTRINGVALUE(Com::tNozzleSize,"Nozzle size [mm]")
FSTRINGVALUE(Com::tFanType,"Fan type")
FSTRINGVALUE(Com::tRearConnVer,"Rear conn. ver.")
FSTRINGVALUE(Com::tFilamentSensor,"Filament sensor")
FSTRINGVALUE(Com::tSSWVer,"SSW version")
FSTRINGVALUE(Com::tVentilation,"Ventilation")
FSTRINGVALUE(Com::tZProbeActX,"Z probe act. X [mm]")
FSTRINGVALUE(Com::tZProbeActY,"Z probe act. Y [mm]")
FSTRINGVALUE(Com::tFusbVer,"Front USB ver.")
FSTRINGVALUE(Com::tEstpVer,"Endstop ver.")
FSTRINGVALUE(Com::tHWVer,"Hardware ver.")
FSTRINGVALUE(Com::tCartVer,"Cartridge ver.")
FSTRINGVALUE(Com::tChTempSens,"Chamber temp. sens.")
FSTRINGVALUE(Com::tChHeatVer,"Chamber heater ver.")
FSTRINGVALUE(Com::tDoorSwVer,"Door switch ver.")
FSTRINGVALUE(Com::tProbeType,"Probe type")
FSTRINGVALUE(Com::tHeadVer,"Head ver.")
FSTRINGVALUE(Com::tPSVer,"Power supply ver.")
FSTRINGVALUE(Com::tBedLED,"Bed LED")
FSTRINGVALUE(Com::tAxisDrv,"Axis driver")
FSTRINGVALUE(Com::tExtDrv,"Extruder driver")
