...
#define EXT0_EXTRUDER_COOLER_SPEED 0
...
/** PWM speed for the cooler fan. 0=off 255=full speed */
#define EXT1_EXTRUDER_COOLER_SPEED 0
#define EXT2_EXTRUDER_COOLER_SPEED 0
/** Time in ms between a heater action and test of success. Must be more then time between turning heater on and first temp. rise! */
...
*/
#define DELTA_SEGMENTS_PER_SECOND_PRINT 300 // Move accurate setting for print moves
...
#define HARDWARE_VERSION "v2U-D600"
#define FIRMWARE_VERSION "226-something-something"
