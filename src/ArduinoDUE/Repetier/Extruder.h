...
//  uint8_t invertDir; ///< 1 if the direction of the extruder should be inverted.
    ...
    static void setTemperatureForExtruder(float temp_celsius,uint8_t extr, bool wait = false);
...
#define CHAMBER_CONTROLLER_INDEX HEATED_BED_INDEX+1
extern TemperatureController chamberController;
#else
#define CHAMBER_CONTROLLER_INDEX HEATED_BED_INDEX
#endif
