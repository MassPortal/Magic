...
FSTRINGVAR(tPrinterModel)
FSTRINGVAR(tExtruderCount)
FSTRINGVAR(tHeatbedType)
FSTRINGVAR(tUinterfaceType)
FSTRINGVAR(tNozzleSize)
FSTRINGVAR(tFanType)
FSTRINGVAR(tRearConnVer)
FSTRINGVAR(tFilamentSensor)
FSTRINGVAR(tSSWVer)
FSTRINGVAR(tVentilation)
FSTRINGVAR(tZProbeActX)
FSTRINGVAR(tZProbeActY)
FSTRINGVAR(tFusbVer)
FSTRINGVAR(tEstpVer)
FSTRINGVAR(tHWVer)
FSTRINGVAR(tCartVer)
FSTRINGVAR(tChTempSens)
FSTRINGVAR(tChHeatVer)
FSTRINGVAR(tDoorSwVer)
FSTRINGVAR(tProbeType)
FSTRINGVAR(tHeadVer)
FSTRINGVAR(tPSVer)
FSTRINGVAR(tBedLED)
...
#ifdef DEBUG
#define SHOW(x) {Com::printF(" " #x "="); Com::print(x); Com::println();}
#define SHOWS(x) {Com::printF(" " #x "="); Com::print(x); Com::print(" steps  "); Com::print(x/80); Com::printFLN(" mm");}
#define SHOWM(x) {Com::printF(" " #x "="); Com::print((long)x*80); Com::print(" steps  "); Com::print(x); Com::printFLN(" mm");}
#define SHOT(x) Com::printF(x " ")
