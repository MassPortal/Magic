...
void Extruder::extStep(uint8_t ext)
{
    switch (ext) {
#if defined (EXT0_STEP_PIN)
    case 0:
        WRITE(EXT0_STEP_PIN,START_STEP_WITH_HIGH);
        break;
#endif /* Has pin */
#if defined (EXT1_STEP_PIN)
    case 1:
        WRITE(EXT1_STEP_PIN,START_STEP_WITH_HIGH);
        break;
#endif /* Has pin */
#if defined (EXT2_STEP_PIN)
    case 2:
        WRITE(EXT2_STEP_PIN,START_STEP_WITH_HIGH);
        break;
#endif /* Has pin */
...
void Extruder::extUnstep(uint8_t ext)
{
        switch (ext) {
#if defined (EXT0_STEP_PIN)
    case 0:
...
void Extruder::enableExt(uint8_t ext)
{
    digitalWrite(extruder[ext].enablePin,extruder[ext].enableOn);
}
...
#if NUM_EXTRUDER > 0
    {
        FI_UNKNOWN, 0, PIN_SW_E0_F, PIN_SW_E0_L, PIN_SW_E0_E, 0,EXT0_X_OFFSET,EXT0_Y_OFFSET,EXT0_Z_OFFSET,EXT0_STEPS_PER_MM,EXT0_ENABLE_PIN,EXT0_ENABLE_ON,
...
#if NUM_EXTRUDER > 1
    ,{
        FI_UNKNOWN, 0, PIN_SW_E1_F, PIN_SW_E1_L, PIN_SW_E1_E, 1,EXT1_X_OFFSET,EXT1_Y_OFFSET,EXT1_Z_OFFSET,EXT1_STEPS_PER_MM,EXT1_ENABLE_PIN,EXT1_ENABLE_ON,
...
#if NUM_EXTRUDER > 2
    ,{
        FI_UNKNOWN, 0, -1, -1, -1, 2,EXT2_X_OFFSET,EXT2_Y_OFFSET,EXT2_Z_OFFSET,EXT2_STEPS_PER_MM,EXT2_ENABLE_PIN,EXT2_ENABLE_ON,
...
#if NUM_EXTRUDER > 3
    ,{
        FI_UNKNOWN, -1, -1, 3,EXT3_X_OFFSET,EXT3_Y_OFFSET,EXT3_Z_OFFSET,EXT3_STEPS_PER_MM,EXT3_ENABLE_PIN,EXT3_ENABLE_ON,
...
#if NUM_EXTRUDER > 4
    ,{
        FI_UNKNOWN, -1, -1, -1, 4,EXT4_X_OFFSET,EXT4_Y_OFFSET,EXT4_Z_OFFSET,EXT4_STEPS_PER_MM,EXT4_ENABLE_PIN,EXT4_ENABLE_ON,
...
#if NUM_EXTRUDER > 5
    ,{
        FI_UNKNOWN, -1, -1, -1, 5,EXT5_X_OFFSET,EXT5_Y_OFFSET,EXT5_Z_OFFSET,EXT5_STEPS_PER_MM,EXT5_ENABLE_PIN,EXT5_ENABLE_ON,
