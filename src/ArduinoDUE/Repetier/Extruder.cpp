...
#if NUM_EXTRUDER > 0
    {
        FI_UNKNOWN, 0, 25, 27, 0,EXT0_X_OFFSET,EXT0_Y_OFFSET,EXT0_Z_OFFSET,EXT0_STEPS_PER_MM,EXT0_ENABLE_PIN,EXT0_ENABLE_ON,
...
#if NUM_EXTRUDER > 1
    ,{
        FI_UNKNOWN, 0, 29, 31, 1,EXT1_X_OFFSET,EXT1_Y_OFFSET,EXT1_Z_OFFSET,EXT1_STEPS_PER_MM,EXT1_ENABLE_PIN,EXT1_ENABLE_ON,
...
#if NUM_EXTRUDER > 2
    ,{
        FI_UNKNOWN, 0, -1, -1, 2,EXT2_X_OFFSET,EXT2_Y_OFFSET,EXT2_Z_OFFSET,EXT2_STEPS_PER_MM,EXT2_ENABLE_PIN,EXT2_ENABLE_ON,
...
#if NUM_EXTRUDER > 4
    ,{
        FI_UNKNOWN, -1, -1, 4,EXT4_X_OFFSET,EXT4_Y_OFFSET,EXT4_Z_OFFSET,EXT4_STEPS_PER_MM,EXT4_ENABLE_PIN,EXT4_ENABLE_ON,
...
#if NUM_EXTRUDER > 5
    ,{
        FI_UNKNOWN, -1, -1, 5,EXT5_X_OFFSET,EXT5_Y_OFFSET,EXT5_Z_OFFSET,EXT5_STEPS_PER_MM,EXT5_ENABLE_PIN,EXT5_ENABLE_ON,
